...
// Keep the persisted directory identity so reinstalling replaces the old
// bundle that still carried speaker models instead of leaving it orphaned.
...
export const mediaDubbingVoxCpm2Definition: ExternalLibraryDefinition =
  Object.freeze({
    ...
    description:
      '使用 one-shot 声音克隆为已经完成字幕和翻译的视频或音频生成配音，并保留背景声进行分段混音。',
    category: 'media',
    ...
    packages: Object.freeze([
      Object.freeze({
        ...
        estimatedInstalledSize: 12 * 1024 * 1024 * 1024,
        recommendedFreeSpace: 18 * 1024 * 1024 * 1024,
